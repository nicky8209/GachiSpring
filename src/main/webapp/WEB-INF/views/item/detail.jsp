  ...
  <div class="row g-5">
    <div class="col-md-8">
      <h3 class="pb-4 mb-4 fst-italic border-bottom">
        <fmt:formatNumber type="number" maxFractionDigits="3" value="${data.price}" />원
      </h3>

      <article class="blog-post">
        <h2 class="display-5 link-body-emphasis mb-1">${ data.title }</h2>
        <p class="blog-post-meta"><a href="#">${ data.category }</a> · <fmt:formatDate value="${data.insert_date}" pattern="yyyy.MM.dd HH:mm:ss" /></p>
