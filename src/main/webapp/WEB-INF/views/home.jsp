...
<div class="col-lg-8 mx-auto p-4 py-md-5">
  ...
  <main>
    <h1 class="text-body-emphasis" style="color: #664d03">혼자 사면 비싸지? 가치 사자!</h1>
    <p class="fs-5 col-md-8" style="color: #664d03">한 개를 사면 비싸지만 여러 개를 사면 더 싼 것들을 동네 친구들과 같이 사보세요!</p>

    <div class="mb-5">
      <a href="../create/" class="btn btn-primary btn-lg px-4">시작하기</a>
    </div>
    ...
    <div class="row g-5">
      ...
      <div class="col-md-6">
        <h2 class="text-body-emphasis">To Do..?</h2>
        <p>앞으로 추가될 기능입니다.</p>
        <ul class="list-unstyled ps-0">
          <li class="d-flex align-items-start mb-1">📝 회원가입 및 로그인</li>
          <li class="d-flex align-items-start mb-1">📝 물건 올리기, 사진</li>
          <li class="d-flex align-items-start mb-1">📝 회원 간 거래 채팅</li>
        </ul>
      </div>
    </div>
  </main>
